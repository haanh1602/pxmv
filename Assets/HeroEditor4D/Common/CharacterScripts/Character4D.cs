...
namespace Assets.HeroEditor4D.Common.CharacterScripts
{
	...
	public class Character4D : Character4DBase
	{
		...
		public FirstDirection firstDirection = FirstDirection.ALL;

		private Dictionary<FirstDirection, Vector2> firstDirectionDic = new Dictionary<FirstDirection, Vector2>()
		{
			{FirstDirection.ALL, Vector2.zero}, {FirstDirection.FRONT, Vector2.down}, {FirstDirection.RIGHT, Vector2.right},
			{FirstDirection.BACK, Vector2.up}, {FirstDirection.LEFT, Vector2.left}
		};
