...
namespace Assets.HeroEditor4D.Common.ExampleScripts
{
	...
	public class CharacterControls : MonoBehaviour
	{
        ...
        {
            List<Vector2> direction = new List<Vector2>() {Vector2.down, Vector2.right, Vector2.up, Vector2.left};
            int i = direction.IndexOf(Character.Direction);
            Character.SetDirection(direction[(i + 1 + direction.Count) % direction.Count]);
        }
