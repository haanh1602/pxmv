    ...
    public class ShopBase : ItemWorkspace
    {
        ...
        public void Buy()
        {
            ...
            if (GetCurrency(Bag, CurrencyId) < price)
            {
                ...
                TapHeroes.Scripts.Interface.Popup.Instance.ShowMessage(SimpleLocalization.LocalizationManager.Localize("Common.NoFunds", "[" + new Item(CurrencyId).Params.GetLocalizedName() + "]"), CurrencyId, NoMoney);
